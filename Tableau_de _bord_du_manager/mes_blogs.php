...
<head>
    ...
    <style>
        ...
        .card-img-top {
            ...
            border-radius: 4px; /* Optional: Adds a small border radius to the images */
        }
    </style>
</head>
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_blog'])) {
                        ...
                        if ($stmt->execute()) {
                            echo '<div class="alert alert-success" role="alert">Blog supprimé avec succès.</div>';
                        } else {
                            echo '<div class="alert alert-danger" role="alert">Erreur lors de la suppression du blog.</div>';
                        }
                    }
                    ...
                    if (empty($blogs)) {
                        ...
                        foreach ($blogs as $blog) {
                            ...
                            $truncated_description = strlen($blog['Description']) > 100 ? substr($blog['Description'], 0, 100) . '...' : $blog['Description'];
                            echo '<p class="card-text">' . htmlspecialchars($truncated_description) . '</p>';
