                ...
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            <div class="row formtype">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Auteur</label>
                                        <input type="text" class="form-control" name="auteur" value="Manager Name" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
                            ...
                            $auteur = $_POST['auteur']; // Assuming it's the name of the manager
                            $authID = $_SESSION['authentification_id']; // Assuming AuthentificationID is stored in session
                            ...
                            if ($stmt = $pdo->prepare($sql)) {
                                ...
                                if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                                    ...
                                    echo '<div class="alert alert-danger mt-3" role="alert">Error: File upload failed.</div>';
                                }
                            } else {
                                // Error handling
