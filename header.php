...
// Debugging: Output the profile photo path
echo "<!-- Profile photo path: $profilePhotoPath -->";
?>

<div class="header">
    <div class="header-left">
        <a href="Tableau_de _bord_du_employe/employe.php" class="logo">
            <img src="assets/img/hrLogo.png" width="50" height="70" alt="logo">
        </a>
        <a href="Tableau_de _bord_du_employe/employe.php" class="logo logo-small">
